#ifndef __TRANSPORT_RTPS_REA_LISTENER_H__
#define __TRANSPORT_RTPS_REA_LISTENER_H__
...
namespace transport
{
    ...
    public:
        using NewMsgCallback =
            std::function<void(uint64_t channel_id, const std::shared_ptr<std::string> &msg_str,
        ...
        void
        onNewCacheChangeAdded(eprosima::fastrtps::rtps::RTPSReader *reader,
