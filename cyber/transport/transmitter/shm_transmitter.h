#ifndef __TRANSPORT_TRANSMITTER_SHM_TRANSMITTER_H__
#define __TRANSPORT_TRANSMITTER_SHM_TRANSMITTER_H__
...
namespace transport
{
    ...
    ShmTransmitter<M>::ShmTransmitter(const RoleAttributes &attr)
        : Transmitter<M>(attr), segment_(nullptr), channel_id_(attr.channel_id), notifier_(nullptr)
    {
