#ifndef __TRANSPORT_TRANSPORT_H__
#define __TRANSPORT_TRANSPORT_H__
...
namespace transport
{
    ...
    /**
     * @brief  Transport 构造时会创建 participant，然后通过CreateTransmitter
     * 将此participant作为参数传递用于创建 RtpsTransmitte
     */
    class Transport
    {
    public:
