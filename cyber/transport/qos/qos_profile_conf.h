#ifndef __TRANSPORT_QOS_QOS_PROFILE_CONF_H__
#define __TRANSPORT_QOS_QOS_PROFILE_CONF_H__
...
namespace transport
{
    ...
    public:
        ...
        static QosProfile CreateQosProfile(const QosHistoryPolicy &history, uint32_t depth,
                                           uint32_t mps, const QosReliabilityPolicy &reliability,
